#include "InputDirectorViewModelBT.h"

InputDirectorViewModelBT::InputDirectorViewModelBT() : simulatorMode(true),
simObject(SimulatorModel()), simOutput(nullptr), btClient(nullptr), serialClient(nullptr) {}

InputDirectorViewModelBT::InputDirectorViewModelBT(bool simState,
...
bool InputDirectorViewModelBT::handleInput(buttonType inputType, int newValue,
