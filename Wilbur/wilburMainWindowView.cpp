...
// Local header files
#include "WilburMainWindowView.h"
...
// Main Window Class
WilburMainWindowView::WilburMainWindowView(QWidget* parent, int simulatorMode) : QMainWindow(parent)
{
    ...
    navigationBar = new NavigationBarView(this, actionLog);
...
WilburMainWindowView::~WilburMainWindowView()
{
}